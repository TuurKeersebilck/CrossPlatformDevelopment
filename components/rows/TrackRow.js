            ...
            <View style={styles.track}>
                ...
                {!isMobile && (
                    <View style={styles.trackDurationContainer}>
                        <Text 
                            style={[styles.trackDuration, isDarkMode && styles.trackDurationDark]}
                ...
                <TouchableOpacity 
                    ...
                    accessibilityRole="button"
                    accessibilityLabel={isFavorited ? `Remove ${track.title} from favorites` : `Add ${track.title} to favorites`}
                >
                    <Ionicons
